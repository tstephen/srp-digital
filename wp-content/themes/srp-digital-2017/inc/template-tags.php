...
function boardwalk_entry_meta() {
	...
	if ( is_single() ) {
		...
		$posted_on = 'XX<a href="' . esc_url( boardwalk_get_link_url() ) . '" rel="bookmark">' . __( 'Featured', 'boardwalk' ) . '</a>';
	} else {
		$posted_on = 'YY<a href="' . esc_url( boardwalk_get_link_url() ) . '" rel="bookmark">' . $time_string . '</a>';
	}
