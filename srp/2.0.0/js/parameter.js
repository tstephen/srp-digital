...
//      console.info('sorted:'+column);
    ...
    stdPartials: [
      ...
      { "name": "navbar", "url": "2.0.0/partials/parameter-navbar.html"},
      ...
      { "name": "parameterListSect", "url": "2.0.0/partials/parameter-list-sect.html"},
      { "name": "parameterCurrentSect", "url": "2.0.0/partials/parameter-current-sect.html"}
    ],
    title: "Parameters"
  },
  add: function () {
